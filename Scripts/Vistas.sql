...
SELECT
    inv.PKIdInversion,
    -- Descripci�n de la cuenta bancaria (similar al campo Descripcion original)
...
-- =============================================
-- Vista 1: ORCO.Vw_OrdenCompra
-- =============================================
IF OBJECT_ID(N'ORCO.Vw_OrdenCompra', N'V') IS NOT NULL
    DROP VIEW ORCO.Vw_OrdenCompra;
GO

CREATE VIEW ORCO.Vw_OrdenCompra AS
SELECT
    oc.PKIdOrdenCompra,
    oc.FKIdEmpresa_SIS,
    e.Nombre AS EmpresaNombre,
...
-- =============================================
-- Vista 2: ORCO.Vw_OrdenCompraDetalle
-- =============================================
IF OBJECT_ID(N'ORCO.Vw_OrdenCompraDetalle', N'V') IS NOT NULL
    DROP VIEW ORCO.Vw_OrdenCompraDetalle;
GO

CREATE VIEW ORCO.Vw_OrdenCompraDetalle AS
SELECT
...
-- =============================================
-- Vista 3: ORCO.Vw_OrdenCompraPartida
-- =============================================
IF OBJECT_ID(N'ORCO.Vw_OrdenCompraPartida', N'V') IS NOT NULL
    DROP VIEW ORCO.Vw_OrdenCompraPartida;
GO

CREATE VIEW ORCO.Vw_OrdenCompraPartida AS
SELECT
