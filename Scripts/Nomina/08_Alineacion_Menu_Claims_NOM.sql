...
(N'Configuracion_RH', N'Sexo', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Estado_Civil', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Escolaridad', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Tipo_Parentesco', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Estado', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Banco', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Municipio', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Base_Pago', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Metodo_Pago', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Tipo_Regimen', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Base_Cotizacion', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Zona_Geografica', 'view,view-menu,delete,new,update,CanExportToExcel'),
(N'Configuracion_RH', N'Dia_Semana', 'view,view-menu,delete,new,update,CanExportToExcel'),
