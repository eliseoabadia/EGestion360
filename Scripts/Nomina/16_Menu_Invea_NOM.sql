...
VALUES
    (610, N'Calculo', 1, 7, N'Calculo_2050', N'/nom/calcnomina', N'FaCalculate', 1, N'ESP', 2, 1, @Now),
    ...
    (631, N'Resumen', 2, 630, N'Resumen', N'/nom/resumennomina', N'FaChartPie', 1, N'ESP', 1, 1, @Now),
    (632, N'Recibos', 2, 630, N'Recibos', N'/nom/recibonomina', N'FaReceiptLong', 1, N'ESP', 2, 1, @Now),
    ...
    (635, N'Reporte Cuotas IMSS', 2, 630, N'Reporte_Cuotas_IMSS', N'/aux/imssquincenal_rep', N'FaChartBar', 1, N'ESP', 5, 1, @Now),
    ...
    (650, N'Pagos Extraordinarios', 1, 7, N'Conceptos_Variables', N'/nom/conceptovariable', N'FaAttachMoney', 1, N'ESP', 6, 1, @Now),
    (660, N'Cierre de Periodo', 1, 7, N'Cierre_Periodo', N'/nom/cierraperiodo', N'FaLock', 1, N'ESP', 7, 1, @Now),
    (670, N'Finiquito/Liquidacion', 1, 7, N'Liquidacion', N'/rh/liquidacion', N'FaReceiptLong', 1, N'ESP', 8, 1, @Now),
    ...
    (690, N'Vacaciones', 1, 7, N'Nomina_Vacaciones', N'/', N'FaEventAvailable', 1, N'ESP', 10, 1, @Now),
    (691, N'Solicitud de Vacaciones', 2, 690, N'Solicitud_Vacaciones', N'/sis/solicitudvacaciones', N'FaCalendar', 1, N'ESP', 1, 1, @Now),
    (692, N'Autorizacion de Vacaciones', 2, 690, N'Autorizacion_Vacaciones', N'/sis/autorizacionvacaciones', N'FaVerified', 1, N'ESP', 2, 1, @Now),
    (700, N'Historicos de Nomina', 0, 7, N'Nomina_Historicos', N'/', N'FaClock', 1, N'ESP', 11, 1, @Now),
    ...
    (740, N'Impuestos sobre Nomina locales', 1, 700, N'Impuestos_Locales', N'/nomina/historicos/impuestoslocales', N'FaHouse', 1, N'ESP', 4, 1, @Now),
    (800, N'Configuracion Nominas', 0, 7, N'Configuracion_Nominas', N'/', N'FaCog', 1, N'ESP', 12, 1, @Now),
    ...
    (900, N'Configuracion RH', 0, 7, N'Configuracion_RH', N'/rh/configuracion', N'FaGears', 1, N'ESP', 13, 1, @Now),
...
VALUES
    ...
    (N'Nomina_Historicos', N'Nomina_Productos_Historicos', 'view,view-menu'),
    (N'Nomina_Historicos', N'Reportes_IMSS_Historicos', 'view,view-menu'),
    (N'Nomina_Historicos', N'Reportes_SAT_Historicos', 'view,view-menu'),
