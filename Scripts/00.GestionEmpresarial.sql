...
USING (VALUES
    ...
    (2, N'Presupuesto', 1, NULL, N'Presupuesto', N'/', N'FaChartPie', 1, 'ESP', 2, 1, GETDATE()),
    (3, N'Contabilidad', 1, NULL, N'Contabilidad', N'/', N'FaTable', 1, 'ESP', 3, 1, GETDATE()),
    (4, N'Adquisiciones', 1, NULL, N'Adquisiciones', N'/', N'RiListCheck2', 1, 'ESP', 4, 1, GETDATE()),
    ...
    (50, N'Sistema', 1, 1, N'Sistema', N'/', N'FaTools', 1, 'ESP', 1, 1, GETDATE()),
    (51, N'Usuario', 2, 50, N'Usuario', N'/configuracion/sistema/usuarios', N'FaUserCircle', 1, 'ESP', 2, 1, GETDATE()),
    (52, N'Menú', 2, 50, N'Menú', N'/configuracion/sistema/menu', N'RiMenuLine', 1, 'ESP', 3, 1, GETDATE()),
    (53, N'General', 2, 50, N'General', N'/configuracion/sistema/general', N'FaGears', 1, 'ESP', 4, 1, GETDATE()),
    (54, N'Empresa', 2, 50, N'Empresa', N'/configuracion/sistema/empresa', N'FaHome', 1, 'ESP', 5, 1, GETDATE()),
    (55, N'Departamento', 2, 50, N'Departamento', N'/configuracion/sistema/departamento', N'FaUserGroup', 1, 'ESP', 6, 1, GETDATE()),

    -- Configuración -> Catálogos presupuestales
    (100, N'Presupuestales', 1, 1, N'Presupuestales', N'/', N'FaChartBar', 1, 'ESP', 1, 1, GETDATE()),
    (219, N'Programas Presupuestales', 2, 100, N'Programas Presupuestales.', N'/configuracion/presupuestales/programas-presupuesta', N'FaFolderOpen', 1, 'ESP', 1, 1, GETDATE()),
    (220, N'Clave del Programa', 2, 100, N'Clave del Programa', N'/configuracion/presupuestales/programa-presupuestal', N'FaKey', 1, 'ESP', 1, 1, GETDATE()),
    ...
    (224, N'SubFunción', 2, 220, N'SubFunción', N'/configuracion/presupuestales/clave-programa/subfuncion', N'FaTools', 1, 'ESP', 5, 1, GETDATE()),
    ...
    (228, N'Programa Presupuestal', 2, 220, N'Programa Presupuestal', N'/configuracion/presupuestales/clave-programa/programa-presupuestal', N'FaDocument', 1, 'ESP', 9, 1, GETDATE()),
    ...
    (236, N'Fuente Financiamiento', 2, 220, N'Fuente Financiamiento', N'/configuracion/presupuestales/clave-programa/fuente-financiamiento', N'FaChartPie', 1, 'ESP', 17, 1, GETDATE()),
    ...
    (244, N'Matriz Conversión Ingresos', 2, 240, N'Matriz Conversión Ingresos', N'/configuracion/contabilidad/matriz-conversion-ingresos', N'FaChartBar', 1, 'ESP', 5, 1, GETDATE()),
    ...
    (247, N'Formas Pago', 2, 240, N'Formas Pago', N'/configuracion/contabilidad/formas-pago', N'FaSave', 1, 'ESP', 8, 1, GETDATE()),

    -- Configuración -> Adquisiciones
    (250, N'Adquisiciones', 1, 1, N'Adquisiciones', N'/', N'RiListCheck2', 1, 'ESP', 3, 1, GETDATE()),
    ...
    (259, N'Fracción', 2, 250, N'Fracción', N'/configuracion/adquisiciones/fraccion', N'RiListCheck2', 1, 'ESP', 12, 1, GETDATE()),

    -- Configuración -> Patrimonio
    (260, N'Patrimonio', 1, 1, N'Patrimonio', N'/', N'FaFolder', 1, 'ESP', 3, 1, GETDATE()),
    (261, N'Familia', 2, 260, N'Familia', N'/configuracion/Patrimonio/Familia', N'FaFolder', 1, 'ESP', 1, 1, GETDATE()),
    (262, N'Grupo Bien', 2, 260, N'Grupo Bien', N'/configuracion/Patrimonio/Grupo_Bien', N'FaFolderOpen', 1, 'ESP', 2, 1, GETDATE()),
    (263, N'Bienes y Servicios', 2, 260, N'Bienes y Servicios', N'/configuracion/Patrimonio/Bienes_Servicios', N'FaTag', 1, 'ESP', 3, 1, GETDATE()),
    (264, N'Tipo de Patrimonio', 2, 260, N'Tipo de Patrimonio', N'/configuracion/Patrimonio/Tipo_Patrimonio', N'FaFolder', 1, 'ESP', 4, 1, GETDATE()),
    ...
    (266, N'Marca', 2, 260, N'Marca', N'/configuracion/Patrimonio/Marca', N'FaStar', 1, 'ESP', 6, 1, GETDATE()),
    ...
    (271, N'Motivo de Entradas Salidas', 2, 270, N'Motivo de Entradas Salidas', N'/configuracion/almacen/Motivo_Entradas_Salidas', N'FaTools', 1, 'ESP', 1, 1, GETDATE()),
    ...
    (281, N'Tipo de Cambio', 2, 280, N'Tipo de Cambio', N'/configuracion/tesoreria/Tipo_Cambio', N'FaChartLine', 1, 'ESP', 1, 1, GETDATE()),
    (282, N'Tipo Inversion', 2, 280, N'Tipo Inversion', N'/configuracion/tesoreria/Tipo_Inversion', N'FaChartBar', 1, 'ESP', 2, 1, GETDATE()),
    (283, N'Tipo Moneda', 2, 280, N'Tipo Moneda', N'/configuracion/tesoreria/Tipo_Moneda', N'FaTag', 1, 'ESP', 3, 1, GETDATE()),
    (284, N'Tipo de Pago', 2, 280, N'Tipo de Pago', N'/configuracion/tesoreria/Tipo_Pago', N'FaDocument', 1, 'ESP', 4, 1, GETDATE()),
    (285, N'Tipo de Pago SF', 2, 280, N'Tipo de Pago SF', N'/configuracion/tesoreria/Tipo_PagoSF', N'FaDocument', 1, 'ESP', 5, 1, GETDATE()),
    (286, N'Tipo Solicitud CLC', 2, 280, N'Tipo Solicitud CLC', N'/configuracion/tesoreria/Tipo_Solicitud_CLC', N'FaFile', 1, 'ESP', 6, 1, GETDATE()),
    ...
    (310, N'Planeación', 1, 300, N'Planeación', N'/', N'FaCalendar', 1, 'ESP', 1, 1, GETDATE()),
     (301, N'Presupuesto Autorizado', 2, 300, N'Presupuesto Autorizado', N'/Presupuesto/Egreso/Presupuesto_Autorizado', N'FaLock', 1, 'ESP', 2, 1, GETDATE()),
    (330, N'Presupuesto Modificado', 1, 300, N'Presupuesto Modificado', N'/', N'FaSearch', 1, 'ESP', 2, 1, GETDATE()),
     (331, N'Adecuaciones Compensadas', 2, 330, N'Adecuaciones Compensadas', N'/Presupuesto/Egreso/Presupesto_Modificado/Adecuaciones_Compensadas', N'FaDocument', 1, 'ESP', 2, 1, GETDATE()),
     (332, N'Adecuaciones', 2, 330, N'Adecuaciones', N'/Presupuesto/Egreso/Presupesto_Modificado/Adecuaciones', N'FaDocument', 1, 'ESP', 3, 1, GETDATE()),
     (333, N'Reducciones', 2, 330, N'Reducciones', N'/Presupuesto/Egreso/Presupesto_Modificado/Reducciones', N'FaDocument', 1, 'ESP', 4, 1, GETDATE()),
    (311, N'Anteproyecto de Egresos', 2, 310, N'Anteproyecto de Egresos', N'/Presupuesto/Egreso/Planeacion/Anteproyecto_Egresos', N'FaDocument', 1, 'ESP', 2, 1, GETDATE()),
    (312, N'Presupuesto Comprometido', 1, 300, N'Presupuesto Comprometido', N'/', N'FaLock', 1, 'ESP', 1, 1, GETDATE()), 
     (313, N'Solicitud Suficiencia', 2, 300, N'Solicitud Suficiencia', N'/Presupuesto/Egreso/Presupuesto_Comprometido/Solicitud_Suficiencia', N'FaPlus', 1, 'ESP', 3, 1, GETDATE()),
     (314, N'Autorizacion Suficiencia', 2, 300, N'Autorizacion Suficiencia', N'/Presupuesto/Egreso/Presupuesto_Comprometido/Autorizacion_Suficiencia', N'FaFlag', 1, 'ESP', 4, 1, GETDATE()),
     (315, N'Registro Comprometido', 2, 300, N'Registro Comprometido', N'/Presupuesto/Egreso/Presupuesto_Comprometido/Registro_Comprometido', N'FaSave', 1, 'ESP', 5, 1, GETDATE()),
    ...
    (352, N'Recepción de Facturas y Comprobantes de Pago', 2, 351, N'Recepción de Facturas y Comprobantes de Pago', N'/Presupuesto/Tesorería/CuentasXPagar/Factura_Pago', N'FaFile', 1, 'ESP', 1, 1, GETDATE()),
    (353, N'Provisión del Pago', 2, 351, N'Provisión del Pago', N'/Presupuesto/Tesorería/CuentasXPagar/Provision_Pago', N'FaClock', 1, 'ESP', 1, 1, GETDATE()),
    (354, N'Elaboración de Cheques o Transferencias', 2, 351, N'Elaboración de Cheques o Transferencias', N'/Presupuesto/Tesorería/CuentasXPagar/Cheque_Transferencia', N'FaSave', 1, 'ESP', 1, 1, GETDATE()),
    (370, N'Inversiones', 1, 350, N'Inversiones', N'/', N'FaChartBar', 1, 'ESP', 1, 1, GETDATE()),
    (371, N'Banco', 2, 370, N'Banco', N'/Presupuesto/Tesorería/Inversiones/Banco', N'FaHome', 1, 'ESP', 1, 1, GETDATE()),
    (372, N'Cuenta Bancaria', 2, 370, N'Cuenta Bancaria', N'/Presupuesto/Tesorería/Inversiones/Cuenta_Bancaria', N'FaFile', 1, 'ESP', 1, 1, GETDATE()),
    (373, N'Intermediarios Financiero', 2, 370, N'Intermediarios Financiero', N'/Presupuesto/Tesorería/Inversiones/Intermediarios_Financiero', N'FaUsers', 1, 'ESP', 2, 1, GETDATE()),
    (374, N'Instrumentos de Inversión', 2, 370, N'Instrumentos de Inversión', N'/Presupuesto/Tesorería/Inversiones/Instrumentos_Inversion', N'FaChartPie', 1, 'ESP', 3, 1, GETDATE()),
    (375, N'Listado de Inversiones', 2, 370, N'Listado de Inversiones', N'/Presupuesto/Tesorería/Inversiones/Listado_Inversiones', N'RiListCheck2', 1, 'ESP', 4, 1, GETDATE()),
    (376, N'Tipo de Plazos', 2, 370, N'Tipo de Plazos', N'/Presupuesto/Tesorería/Inversiones/Tipo_Plazos', N'FaClock', 1, 'ESP', 5, 1, GETDATE()),
    (377, N'Tipo de Retiro', 2, 370, N'Tipo de Retiro', N'/Presupuesto/Tesorería/Inversiones/Tipo_Retiro', N'FaLockOpen', 1, 'ESP', 6, 1, GETDATE()),

    (400, N'Programa Anual', 2, 4, N'Programa Anual', N'/Adquisiciones/Programa_Anual', N'FaCalendar', 1, 'ESP', 4, 1, GETDATE()),
    ...
    (500, N'Pólizas', 2, 3, N'Pólizas', N'/Contabilidad/Polizas', N'FaDocument', 1, 'ESP', 4, 1, GETDATE()),


    (601, N'Bienes', 2, 5, N'Bienes', N'/Patrimonio/Bienes', N'FaLock', 1, 'ESP', 2, 1, GETDATE()),
    (602, N'Clasificación de Bienes Muebles', 2, 5, N'Clasificación de Bienes Muebles', N'/Patrimonio/Clasificacion_Bienes_Muebles', N'FaLock', 1, 'ESP', 3, 1, GETDATE()),
    (603, N'Bajas', 2, 5, N'Bajas', N'/Patrimonio/Bajas', N'FaLock', 1, 'ESP', 4, 1, GETDATE()),
    (604, N'Calendario de Inventarios', 2, 5, N'Calendario de Inventarios', N'/Patrimonio/Calendario_Inventarios', N'FaLock', 1, 'ESP', 5, 1, GETDATE()),
    (605, N'Inventarios', 2, 5, N'Inventarios', N'/Patrimonio/Inventarios', N'FaLock', 1, 'ESP', 6, 1, GETDATE()),
    (606, N'Cédula de Diferencia', 2, 5, N'Cédula de Diferencia', N'/Patrimonio/Cedula_Diferencia', N'FaLock', 1, 'ESP', 7, 1, GETDATE()),
    (607, N'Resguardos', 2, 5, N'Resguardos', N'/Patrimonio/Resguardos', N'FaLock', 1, 'ESP', 8, 1, GETDATE()),
    (608, N'Firma Resguardos', 2, 5, N'Firma Resguardos', N'/Patrimonio/Firma_Resguardos', N'FaLock', 1, 'ESP', 9, 1, GETDATE()),
    (609, N'Resguardo Historico', 2, 5, N'Resguardo Historico', N'/Patrimonio/Resguardo_Historico', N'FaLock', 1, 'ESP', 10, 1, GETDATE()),


    -- Almacén
    (700, N'Recepción de Pedidos', 2, 6, N'Recepción de Pedidos', N'/Almacen/Recepcion_Pedidos', N'FaLock', 1, 'ESP', 1, 1, GETDATE()),
    (701, N'Entradas por Ajuste', 2, 6, N'Entradas por Ajuste', N'/Almacen/Entradas_Ajuste', N'FaLock', 1, 'ESP', 2, 1, GETDATE()),
    (702, N'Solicitudes de Salida', 2, 6, N'Solicitudes de Salida', N'/Almacen/Solicitudes_Salida', N'FaLock', 1, 'ESP', 3, 1, GETDATE()),
    (703, N'Suministros de Salida', 2, 6, N'Suministros de Salida', N'/Almacen/Suministros_Salida', N'FaLock', 1, 'ESP', 4, 1, GETDATE()),
    (704, N'Existencias Registradas', 2, 6, N'Existencias Registradas', N'/Almacen/Existencias_Registradas', N'FaLock', 1, 'ESP', 5, 1, GETDATE()),
    (705, N'Conteo Cíclico', 2, 6, N'Conteo Cíclico', N'/Almacen/Conteo_ciclico', N'FaLock', 1, 'ESP', 6, 1, GETDATE()),
    (706, N'Reporte de Diferencias de Conteo', 2, 6, N'Reporte de Diferencias de Conteo', N'/Almacen/Reporte_diferencias_Conteo', N'FaLock', 1, 'ESP', 6, 1, GETDATE()),
    (707, N'Conteo Cíclico Anual', 2, 6, N'Conteo Cíclico Anual', N'/Almacen/Conteo_ciclico_anual', N'FaLock', 1, 'ESP', 7, 1, GETDATE()),
    (708, N'Reporte de Diferencias de Conteo Anual', 2, 6, N'Reporte de Diferencias de Conteo Anual', N'/Almacen/Reporte_diferencias_Conteo_anual', N'FaLock', 1, 'ESP', 8, 1, GETDATE())
