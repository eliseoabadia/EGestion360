...
USING (VALUES
    ...
    (51, N'Usuario', 2, 50, N'Usuario', N'/configuracion/sistema/usuarios', N'FaUserCircle', 1, N'ESP', 2, 1, GETDATE()),
    (52, N'Menú', 2, 50, N'Menú', N'/configuracion/sistema/menu', N'RiMenuLine', 1, N'ESP', 3, 1, GETDATE()),
    (53, N'General', 2, 50, N'General', N'/configuracion/sistema/general', N'FaGears', 1, N'ESP', 4, 1, GETDATE()),
    (54, N'Empresa', 2, 50, N'Empresa', N'/configuracion/sistema/empresa', N'FaHome', 1, N'ESP', 5, 1, GETDATE()),
    ...
    (222, N'Finalidad', 2, 220, N'Finalidad', N'/configuracion/presupuestales/clave-programa/finalidad', N'FaFlag', 1, N'ESP', 3, 1, GETDATE()),
    (223, N'Función', 2, 220, N'Función', N'/configuracion/presupuestales/clave-programa/funcion', N'FaGears', 1, N'ESP', 4, 1, GETDATE()),
    (224, N'SubFunción', 2, 220, N'SubFunción', N'/configuracion/presupuestales/clave-programa/subfuncion', N'FaTools', 1, N'ESP', 5, 1, GETDATE()),
    (225, N'Actividad Institucional', 2, 220, N'Actividad Institucional', N'/configuracion/presupuestales/clave-programa/actividad-institucional', N'RiListCheck2', 1, N'ESP', 6, 1, GETDATE()),
    (228, N'Programa Presupuestal', 2, 220, N'Programa Presupuestal', N'/configuracion/presupuestales/clave-programa/programa-presupuestal', N'FaDocument', 1, N'ESP', 9, 1, GETDATE()),
    (232, N'Años', 2, 220, N'Años', N'/configuracion/presupuestales/clave-programa/anios', N'FaCalendar', 1, N'ESP', 13, 1, GETDATE()),
    (233, N'Sector', 2, 220, N'Sector', N'/configuracion/presupuestales/clave-programa/sector', N'FaFolder', 1, N'ESP', 14, 1, GETDATE()),
    (235, N'Tipo Recurso', 2, 220, N'Tipo Recurso', N'/configuracion/presupuestales/clave-programa/tipo-recurso', N'FaTag', 1, N'ESP', 16, 1, GETDATE()),
    (236, N'Fuente Financiamiento', 2, 220, N'Fuente Financiamiento', N'/configuracion/presupuestales/clave-programa/fuente-financiamiento', N'FaChartPie', 1, N'ESP', 17, 1, GETDATE()),
    (237, N'PG', 2, 220, N'PG', N'/configuracion/presupuestales/clave-programa/pg', N'FaDocument', 1, N'ESP', 18, 1, GETDATE()),
    (238, N'Ramo', 2, 220, N'Ramo', N'/configuracion/presupuestales/clave-programa/ramo', N'FaFolderOpen', 1, N'ESP', 19, 1, GETDATE()),
    (239, N'Proyecto', 2, 220, N'Proyecto', N'/configuracion/presupuestales/clave-programa/proyecto', N'FaFolder', 1, N'ESP', 20, 1, GETDATE()),

    -- Configuración -> Contabilidad
    (240, N'Contabilidad', 1, 100, N'Contabilidad', N'/', N'FaTable', 1, N'ESP', 2, 1, GETDATE()),
    (241, N'Tipo Pólizas', 2, 240, N'Tipo Pólizas', N'/configuracion/contabilidad/tipo-polizas', N'FaDocument', 1, N'ESP', 2, 1, GETDATE()),
    (242, N'Tipo Detalles Pólizas', 2, 240, N'Tipo Detalles Pólizas', N'/configuracion/contabilidad/tipo-detalles-polizas', N'RiListCheck2', 1, N'ESP', 3, 1, GETDATE()),
    (243, N'Matriz Conversión', 2, 240, N'Matriz Conversión', N'/configuracion/contabilidad/matriz-conversion', N'FaGears', 1, N'ESP', 4, 1, GETDATE()),
    (244, N'Matriz Conversión Ingresos', 2, 240, N'Matriz Conversión Ingresos', N'/configuracion/contabilidad/matriz-conversion-ingresos', N'FaChartBar', 1, N'ESP', 5, 1, GETDATE()),
    (245, N'Partidas Presupuestales', 2, 240, N'Partidas Presupuestales', N'/configuracion/contabilidad/partidas-presupuestales', N'FaTag', 1, N'ESP', 6, 1, GETDATE()),
    (246, N'Cuentas Contables', 2, 240, N'Cuentas Contables', N'/configuracion/contabilidad/cuentas-contables', N'FaTable', 1, N'ESP', 7, 1, GETDATE()),
    (247, N'Formas Pago', 2, 240, N'Formas Pago', N'/configuracion/contabilidad/formas-pago', N'FaSave', 1, N'ESP', 8, 1, GETDATE()),

    -- Configuración -> Adquisiciones
    (250, N'Adquisiciones', 1, 1, N'Adquisiciones', N'/', N'RiListCheck2', 1, N'ESP', 3, 1, GETDATE()),
    (251, N'Modalidad', 2, 250, N'Modalidad', N'/configuracion/adquisiciones/modalidad', N'FaTag', 1, N'ESP', 4, 1, GETDATE()),
    (252, N'Tipo de Contrato', 2, 250, N'Tipo de Contrato', N'/configuracion/adquisiciones/tipo-contrato', N'FaDocument', 1, N'ESP', 5, 1, GETDATE()),
    (253, N'Tipo de Documentos', 2, 250, N'Tipo de Documentos', N'/configuracion/adquisiciones/tipo-documento', N'FaFile', 1, N'ESP', 6, 1, GETDATE()),
    (254, N'Tipo de Garantía', 2, 250, N'Tipo de Garantía', N'/configuracion/adquisiciones/tipo-garantia', N'FaLock', 1, N'ESP', 7, 1, GETDATE()),
    (255, N'Procedimientos de Contratación', 2, 250, N'Procedimientos de Contratación', N'/configuracion/adquisiciones/procedimientos-contratacion', N'FaGears', 1, N'ESP', 8, 1, GETDATE()),
    (256, N'Estatus Requisición', 2, 250, N'Estatus Requisición', N'/configuracion/adquisiciones/estatus-requisicion', N'FaFlag', 1, N'ESP', 9, 1, GETDATE()),
    (257, N'Proveedores', 2, 250, N'Proveedores', N'/configuracion/adquisiciones/proveedores', N'FaUsers', 1, N'ESP', 10, 1, GETDATE()),
    (258, N'Artículo', 2, 250, N'Artículo', N'/configuracion/adquisiciones/articulo', N'FaTag', 1, N'ESP', 11, 1, GETDATE()),
    ...
    (264, N'Tipo de Patrimonio', 2, 260, N'Tipo de Patrimonio', N'/configuracion/Patrimonio/Tipo_Patrimonio', N'FaFolder', 1, N'ESP', 4, 1, GETDATE()),
    (265, N'Tipo de Adquisición', 2, 260, N'Tipo de Adquisición', N'/configuracion/Patrimonio/Tipo_Adquisicion', N'FaTag', 1, N'ESP', 5, 1, GETDATE()),
    (266, N'Marca', 2, 260, N'Marca', N'/configuracion/Patrimonio/Marca', N'FaStar', 1, N'ESP', 6, 1, GETDATE()),
    ...
    (274, N'Periodo de Conteo', 2, 270, N'Periodo de Conteo', N'/configuracion/almacen/Perido_Conteo', N'FaCalendar', 1, N'ESP', 4, 1, GETDATE()),
    (275, N'Familia', 2, 270, N'Familia', N'/configuracion/almacen/Familia', N'FaFolder', 1, N'ESP', 5, 1, GETDATE()),
    (276, N'Tipo Bien', 2, 270, N'Tipo Bien', N'/configuracion/almacen/Tipo_Bien', N'FaTag', 1, N'ESP', 6, 1, GETDATE()),
    (277, N'Bien', 2, 270, N'Bien', N'/configuracion/almacen/Bien', N'FaTag', 1, N'ESP', 7, 1, GETDATE()),
    ...
    (284, N'Tipo de Pago', 2, 280, N'Tipo de Pago', N'/configuracion/tesoreria/Tipo_Pago', N'FaDocument', 1, N'ESP', 4, 1, GETDATE()),
    (285, N'Tipo de Pago SF', 2, 280, N'Tipo de Pago SF', N'/configuracion/tesoreria/Tipo_PagoSF', N'FaDocument', 1, N'ESP', 5, 1, GETDATE()),
    (286, N'Tipo Solicitud CLC', 2, 280, N'Tipo Solicitud CLC', N'/configuracion/tesoreria/Tipo_Solicitud_CLC', N'FaFile', 1, N'ESP', 6, 1, GETDATE()),
    (287, N'Tipo Documento CLC', 2, 280, N'Tipo Documento CLC', N'/configuracion/tesoreria/Tipo_Documento_CLC', N'FaDocument', 1, N'ESP', 7, 1, GETDATE()),

    -- Presupuesto -> Egreso
    (300, N'Egreso', 1, 2, N'Egreso', N'/', N'FaChartPie', 1, N'ESP', 1, 1, GETDATE()),
    (310, N'Planeación', 1, 300, N'Planeación', N'/', N'FaCalendar', 1, N'ESP', 1, 1, GETDATE()),
    (301, N'Presupuesto Autorizado', 2, 300, N'Presupuesto Autorizado', N'/Presupuesto/Egreso/Presupuesto_Autorizado', N'FaLock', 1, N'ESP', 2, 1, GETDATE()),
    (330, N'Presupuesto Modificado', 1, 300, N'Presupuesto Modificado', N'/', N'FaEdit', 1, N'ESP', 2, 1, GETDATE()),
    (331, N'Adecuaciones Compensadas', 2, 330, N'Adecuaciones Compensadas', N'/Presupuesto/Egreso/Presupesto_Modificado/Adecuaciones_Compensadas', N'FaDocument', 1, N'ESP', 2, 1, GETDATE()),
    (332, N'Adecuaciones', 2, 330, N'Adecuaciones', N'/Presupuesto/Egreso/Presupesto_Modificado/Adecuaciones', N'FaDocument', 1, N'ESP', 3, 1, GETDATE()),
    (333, N'Reducciones', 2, 330, N'Reducciones', N'/Presupuesto/Egreso/Presupesto_Modificado/Reducciones', N'FaDocument', 1, N'ESP', 4, 1, GETDATE()),
    (311, N'Anteproyecto de Egresos', 2, 310, N'Anteproyecto de Egresos', N'/Presupuesto/Egreso/Planeacion/Anteproyecto_Egresos', N'FaDocument', 1, N'ESP', 2, 1, GETDATE()),
    (312, N'Presupuesto Comprometido', 1, 300, N'Presupuesto Comprometido', N'/', N'FaLock', 1, N'ESP', 1, 1, GETDATE()),
    (313, N'Solicitud Suficiencia', 2, 300, N'Solicitud Suficiencia', N'/Presupuesto/Egreso/Presupuesto_Comprometido/Solicitud_Suficiencia', N'FaDocument', 1, N'ESP', 3, 1, GETDATE()),
    (314, N'Autorización Suficiencia', 2, 300, N'Autorización Suficiencia', N'/Presupuesto/Egreso/Presupuesto_Comprometido/Autorizacion_Suficiencia', N'FaFlag', 1, N'ESP', 4, 1, GETDATE()),
    (315, N'Registro Comprometido', 2, 300, N'Registro Comprometido', N'/Presupuesto/Egreso/Presupuesto_Comprometido/Registro_Comprometido', N'FaSave', 1, N'ESP', 5, 1, GETDATE()),

    -- Presupuesto -> Tesorería
    (350, N'Tesorería', 1, 2, N'Tesorería', N'/', N'FaChartLine', 1, N'ESP', 1, 1, GETDATE()),
    (351, N'Cuentas por Pagar', 1, 350, N'Cuentas por Pagar', N'/', N'FaDocument', 1, N'ESP', 1, 1, GETDATE()),
    (352, N'Recepción de Facturas y Comprobantes de Pago', 2, 351, N'Recepción de Facturas y Comprobantes de Pago', N'/Presupuesto/Tesorería/CuentasXPagar/Factura_Pago', N'FaFile', 1, N'ESP', 1, 1, GETDATE()),
    (353, N'Provisión del Pago', 2, 351, N'Provisión del Pago', N'/Presupuesto/Tesorería/CuentasXPagar/Provision_Pago', N'FaClock', 1, N'ESP', 1, 1, GETDATE()),
    (354, N'Elaboración de Cheques o Transferencias', 2, 351, N'Elaboración de Cheques o Transferencias', N'/Presupuesto/Tesorería/CuentasXPagar/Cheque_Transferencia', N'FaSave', 1, N'ESP', 1, 1, GETDATE()),
    (370, N'Inversiones', 1, 350, N'Inversiones', N'/', N'FaChartBar', 1, N'ESP', 1, 1, GETDATE()),
    (371, N'Banco', 2, 370, N'Banco', N'/Presupuesto/Tesorería/Inversiones/Banco', N'FaHome', 1, N'ESP', 1, 1, GETDATE()),
    (372, N'Cuenta Bancaria', 2, 370, N'Cuenta Bancaria', N'/Presupuesto/Tesorería/Inversiones/Cuenta_Bancaria', N'FaFile', 1, N'ESP', 1, 1, GETDATE()),
    (373, N'Intermediarios Financiero', 2, 370, N'Intermediarios Financiero', N'/Presupuesto/Tesorería/Inversiones/Intermediarios_Financiero', N'FaUsers', 1, N'ESP', 2, 1, GETDATE()),
    (374, N'Instrumentos de Inversión', 2, 370, N'Instrumentos de Inversión', N'/Presupuesto/Tesorería/Inversiones/Instrumentos_Inversion', N'FaChartPie', 1, N'ESP', 3, 1, GETDATE()),
    (375, N'Listado de Inversiones', 2, 370, N'Listado de Inversiones', N'/Presupuesto/Tesorería/Inversiones/Listado_Inversiones', N'RiListCheck2', 1, N'ESP', 4, 1, GETDATE()),
    (376, N'Tipo de Plazos', 2, 370, N'Tipo de Plazos', N'/Presupuesto/Tesorería/Inversiones/Tipo_Plazos', N'FaClock', 1, N'ESP', 5, 1, GETDATE()),
    (377, N'Tipo de Retiro', 2, 370, N'Tipo de Retiro', N'/Presupuesto/Tesorería/Inversiones/Tipo_Retiro', N'FaLockOpen', 1, N'ESP', 6, 1, GETDATE()),

    -- Adquisiciones
    (400, N'Programa Anual', 2, 4, N'Programa Anual', N'/Adquisiciones/Programa_Anual', N'FaCalendar', 1, N'ESP', 4, 1, GETDATE()),
    (401, N'Requisición', 2, 4, N'Requisición', N'/Adquisiciones/Requisicion', N'RiListCheck2', 1, N'ESP', 5, 1, GETDATE()),
    (402, N'Cotización', 2, 4, N'Cotización', N'/Adquisiciones/Cotizacion', N'FaDocument', 1, N'ESP', 6, 1, GETDATE()),
    (403, N'Solicitud Suficiencia', 2, 4, N'Solicitud Suficiencia', N'/Adquisiciones/Solicitud_Suficiencia', N'FaDocument', 1, N'ESP', 7, 1, GETDATE()),
    (404, N'Orden de Compra', 2, 4, N'Orden de Compra', N'/Adquisiciones/Orden_Compra', N'FaDocument', 1, N'ESP', 8, 1, GETDATE()),

    -- Contabilidad
    (500, N'Pólizas', 2, 3, N'Pólizas', N'/Contabilidad/Polizas', N'FaDocument', 1, N'ESP', 4, 1, GETDATE()),

    -- Patrimonio
    (601, N'Bienes', 2, 5, N'Bienes', N'/Patrimonio/Bienes', N'FaFolderOpen', 1, N'ESP', 2, 1, GETDATE()),
    (602, N'Clasificación de Bienes Muebles', 2, 5, N'Clasificación de Bienes Muebles', N'/Patrimonio/Clasificacion_Bienes_Muebles', N'FaFolder', 1, N'ESP', 3, 1, GETDATE()),
    (603, N'Bajas', 2, 5, N'Bajas', N'/Patrimonio/Bajas', N'FaTrash', 1, N'ESP', 4, 1, GETDATE()),
    (604, N'Calendario de Inventarios', 2, 5, N'Calendario de Inventarios', N'/Patrimonio/Calendario_Inventarios', N'FaCalendar', 1, N'ESP', 5, 1, GETDATE()),
    (605, N'Inventarios', 2, 5, N'Inventarios', N'/Patrimonio/Inventarios', N'RiListCheck2', 1, N'ESP', 6, 1, GETDATE()),
    (606, N'Cédula de Diferencia', 2, 5, N'Cédula de Diferencia', N'/Patrimonio/Cedula_Diferencia', N'FaDocument', 1, N'ESP', 7, 1, GETDATE()),
    (607, N'Resguardos', 2, 5, N'Resguardos', N'/Patrimonio/Resguardos', N'FaLock', 1, N'ESP', 8, 1, GETDATE()),
    (608, N'Firma Resguardos', 2, 5, N'Firma Resguardos', N'/Patrimonio/Firma_Resguardos', N'FaEdit', 1, N'ESP', 9, 1, GETDATE()),
    (609, N'Resguardo Histórico', 2, 5, N'Resguardo Histórico', N'/Patrimonio/Resguardo_Historico', N'FaFile', 1, N'ESP', 10, 1, GETDATE()),

    -- Almacén
    (700, N'Recepción de Pedidos', 2, 6, N'Recepción de Pedidos', N'/Almacen/Recepcion_Pedidos', N'FaFolderOpen', 1, N'ESP', 1, 1, GETDATE()),
    (701, N'Entradas por Ajuste', 2, 6, N'Entradas por Ajuste', N'/Almacen/Entradas_Ajuste', N'FaPlus', 1, N'ESP', 2, 1, GETDATE()),
    (702, N'Solicitudes de Salida', 2, 6, N'Solicitudes de Salida', N'/Almacen/Solicitudes_Salida', N'RiListCheck2', 1, N'ESP', 3, 1, GETDATE()),
    (703, N'Suministros de Salida', 2, 6, N'Suministros de Salida', N'/Almacen/Suministros_Salida', N'FaFile', 1, N'ESP', 4, 1, GETDATE()),
    (704, N'Existencias Registradas', 2, 6, N'Existencias Registradas', N'/Almacen/Existencias_Registradas', N'FaTable', 1, N'ESP', 5, 1, GETDATE()),
