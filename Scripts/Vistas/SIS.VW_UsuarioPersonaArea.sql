-- =============================================
-- Vista: VW_UsuarioPersonaArea
-- Descripción: Relaciona Usuario, Persona y Área (a través de PersonaArea)
-- =============================================
IF OBJECT_ID('SIS.VW_UsuarioPersonaArea', 'V') IS NOT NULL DROP VIEW SIS.VW_UsuarioPersonaArea;
GO
