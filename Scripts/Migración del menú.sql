...
EXEC sp_RegistrarEntidad @Grupo = 'anteproyecto-de-egresos', @SubGrupo = 'anteproyecto-de-egresos', @NombreMenu = N'Anteproyecto de Egresos', @Ruta = '/PRESVW_EgresoProyectado', @MenuPadreNombre = N'Planeación', @Icono = 'FaRegSun', @Orden = 2, @Descripcion = N'Anteproyecto de Egresos', @Codigo = '1063';  
