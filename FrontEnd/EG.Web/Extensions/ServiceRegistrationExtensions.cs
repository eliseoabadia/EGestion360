...
using EG.Web.Services.Contabilidad;
using EG.Web.Services.DocumentRag;
...
public static class ApiServiceExtensions
{
    public static IServiceCollection AddApiServices(this IServiceCollection services)
    {
        ...
        RegisterCrud<NomConceptoPorcentajeResponse>(services, "api/NomConceptoPorcentaje");
        RegisterCrud<NomConceptoProporcionalResponse>(services, "api/NomConceptoProporcional");
        RegisterCrud<NomConceptoTabularResponse>(services, "api/NomConceptoTabular");
        RegisterCrud<NomConceptoVariableResponse>(services, "api/NomConceptoVariable");
        RegisterCrud<NomContratoTercerosResponse>(services, "api/NomContratoTerceros");
        RegisterCrud<NomCreditoResponse>(services, "api/NomCredito");
        RegisterCrud<NomDescuentoCreditoResponse>(services, "api/NomDescuentoCredito");
        RegisterCrud<NomDescuentoInfonavitResponse>(services, "api/NomDescuentoInfonavit");
        RegisterCrud<NomEstatusPagoResponse>(services, "api/NomEstatusPago");
        RegisterCrud<NomFactorIntResponse>(services, "api/NomFactorInt");
        RegisterCrud<NomInfonavitResponse>(services, "api/NomInfonavit");
        RegisterCrud<NomPeriodoActivoResponse>(services, "api/NomPeriodoActivo");
        RegisterCrud<NomSalarioMinimoResponse>(services, "api/NomSalarioMinimo");
        RegisterCrud<NomSueldoEspecialResponse>(services, "api/NomSueldoEspecial");
        RegisterCrud<NomSueldoLiqFinResponse>(services, "api/NomSueldoLiqFin");
        RegisterCrud<NomSueldoMensualResponse>(services, "api/NomSueldoMensual");
        RegisterCrud<NomSueldoQuincenalResponse>(services, "api/NomSueldoQuincenal");
        RegisterCrud<NomSueldoSemanalResponse>(services, "api/NomSueldoSemanal");
