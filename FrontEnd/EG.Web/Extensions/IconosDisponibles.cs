...
namespace EG.Web.Extensions
{
    public static class IconosDisponibles
    {
        ...
        public static readonly List<IconoItem> Lista = new()
        {
            ...
            new IconoItem { Nombre = "Nomina", Valor = "FaMoneyBillWave", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Payments, BootstrapIcon = "bi bi-cash-stack" },
            new IconoItem { Nombre = "Pagos", Valor = "FaPayments", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Payments, BootstrapIcon = "bi bi-cash-stack" },
            new IconoItem { Nombre = "Calculo", Valor = "FaCalculate", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Calculate, BootstrapIcon = "bi bi-calculator" },
            new IconoItem { Nombre = "Monto", Valor = "FaAttachMoney", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.AttachMoney, BootstrapIcon = "bi bi-cash-coin" },
            new IconoItem { Nombre = "Porcentaje", Valor = "FaPercent", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Percent, BootstrapIcon = "bi bi-percent" },
            new IconoItem { Nombre = "Grafico Circular", Valor = "FaPieChart", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.PieChart, BootstrapIcon = "bi bi-pie-chart" },
            new IconoItem { Nombre = "Filas Tabla", Valor = "FaTableRows", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.TableRows, BootstrapIcon = "bi bi-table" },
            new IconoItem { Nombre = "Ajustes", Valor = "FaTune", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Tune, BootstrapIcon = "bi bi-sliders" },
            new IconoItem { Nombre = "Asignacion", Valor = "FaAssignment", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Assignment, BootstrapIcon = "bi bi-clipboard-check" },
            new IconoItem { Nombre = "Credito", Valor = "FaCreditCard", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.CreditCard, BootstrapIcon = "bi bi-credit-card" },
            new IconoItem { Nombre = "Descuento", Valor = "FaMoneyOff", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.MoneyOff, BootstrapIcon = "bi bi-cash" },
            new IconoItem { Nombre = "Vivienda Trabajo", Valor = "FaHomeWork", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.HomeWork, BootstrapIcon = "bi bi-house-check" },
            new IconoItem { Nombre = "Verificado", Valor = "FaVerified", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Verified, BootstrapIcon = "bi bi-patch-check" },
            new IconoItem { Nombre = "Funciones", Valor = "FaFunctions", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Functions, BootstrapIcon = "bi bi-diagram-3" },
            new IconoItem { Nombre = "Casa", Valor = "FaHouse", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.House, BootstrapIcon = "bi bi-house" },
            new IconoItem { Nombre = "Periodo Activo", Valor = "FaEventAvailable", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.EventAvailable, BootstrapIcon = "bi bi-calendar-check" },
            new IconoItem { Nombre = "Cambio Precio", Valor = "FaPriceChange", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.PriceChange, BootstrapIcon = "bi bi-currency-dollar" },
            new IconoItem { Nombre = "Recibo", Valor = "FaReceiptLong", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.ReceiptLong, BootstrapIcon = "bi bi-receipt" },
            new IconoItem { Nombre = "Mes", Valor = "FaCalendarMonth", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.CalendarMonth, BootstrapIcon = "bi bi-calendar3" },
            new IconoItem { Nombre = "Rango Fechas", Valor = "FaDateRange", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.DateRange, BootstrapIcon = "bi bi-calendar-range" },
            new IconoItem { Nombre = "Semana", Valor = "FaViewWeek", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.ViewWeek, BootstrapIcon = "bi bi-calendar-week" },
            new IconoItem { Nombre = "Incapacidad", Valor = "FaSick", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.Sick, BootstrapIcon = "bi bi-bandaid" },
            new IconoItem { Nombre = "Punto Venta", Valor = "FaPointOfSale", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.PointOfSale, BootstrapIcon = "bi bi-credit-card-2-front" },
            new IconoItem { Nombre = "Familia", Valor = "FaFamilyRestroom", Categoria = "Nomina", MaterialIcon = Icons.Material.Filled.FamilyRestroom, BootstrapIcon = "bi bi-people" },
