...
namespace EG.ApiCoreBS.Controllers.Catalogos.ClavePrograma
{
    ...
    {
        private readonly ISfAppService _appService;
        private readonly IUserContextService _userContext;

        public SfController(ISfAppService appService, IUserContextService userContext)
        {
        ...
        public async Task<ActionResult<PagedResult<SubFuncionResponse>>> Create([FromBody] SubFuncionResponse request)
        {
            ...
            return CreatedAtAction(nameof(GetById), new { id = request.PkidSf }, result);
        }
