...
namespace EG.ApiCoreBS.Controllers.Catalogos.Adquisicion
{
    ...
    {
        private readonly IRequisicionAppService _appService;
        private readonly IUserContextService _userContext;

        public RequisicionController(
            IRequisicionAppService appService,
        ...
        public async Task<ActionResult<PagedResult<RequisicionResponse>>> Create([FromBody] RequisicionResponse response)
        {
            ...
            return CreatedAtAction(nameof(GetById), new { id = response.PkidRequisicion }, result);
        }
