...
{
    public class TipoPagoService(GenericService<TipoPago, TipoPagoDto, TipoPagoResponse> service)
        : GenericCatalogService<TipoPago, TipoPagoDto, TipoPagoResponse>(service), ITipoPagoService;
}
