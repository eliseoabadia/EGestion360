...
{
    public class TipoPagoSFService(GenericService<TipoPagoSf, TipoPagoSFDto, TipoPagoSFResponse> service)
        : GenericCatalogService<TipoPagoSf, TipoPagoSFDto, TipoPagoSFResponse>(service), ITipoPagoSFService;
}
