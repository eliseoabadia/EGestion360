...
{
    public class TipoDoctoClcService(GenericService<TipoDoctoClc, TipoDoctoClcDto, TipoDoctoClcResponse> service)
        : GenericCatalogService<TipoDoctoClc, TipoDoctoClcDto, TipoDoctoClcResponse>(service), ITipoDoctoClcService;
}
